...
\extrainfo{\huggingfaceicon~\href{https://huggingface.co/dipayanskr}{HuggingFace}}
...
% }
\cvitem{2022}{%
	Sarkar, C., \textbf{Sarkar, D.}, Parsad, R., \& Mishra, D. \texttt{EGRNi}: Ensemble Gene Regulatory Network Inference. \textbf{CRAN}, R package version 0.1.6. \href{https://cran.r-project.org/package=EGRNi}{cran.r-project.org/package=EGRNi}
}
% \section{Publications}
...
\cventry{2024}{M.Sc. Bioinformatics, Semester II}{C Programming --- Theory and Laboratory}{University of North Bengal}{}{%
  Delivered theory lectures and conducted laboratory sessions for the 2024 batch.
}

\cventry{2025}{M.Sc. Bioinformatics, Semester I}{Python Graphics --- Laboratory}{University of North Bengal}{}{%
  Conducted practical sessions for the 2025 batch.
}

\cvitem{2025}{%
  \textbf{Dissertation supervision} - Mentored an M.Sc. dissertation student from \textit{Central University of South Bihar, Gaya, India} on \textit{Deep Learning-Based Model for Prediction of Targeted Sequencing Depth Using Probe Sequences}; acknowledged in the submitted thesis. 
  % Project code: \href{<repo url>}{<github.com/...>}
}
...
\cvitem{2025}{%
      \textbf{Google TRC (TPU Research Cloud) Award} - Awarded access to GCloud TPUs (v4, v5e, v6e) for machine learning research.
}
...
\cvitem{Deep Learning}{Transformers, attention mechanisms, transfer learning.}
...
\cvitem{Bioinformatics}{Biological sequence analysis, protein-protein interaction prediction, biomolecular network analysis}
