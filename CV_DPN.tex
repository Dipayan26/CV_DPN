...
\cvitem{2025}{%
  Sarkar, D., \& Sarkar, C. AttnSeq-PPI: Enhancing protein-protein interaction network prediction using transfer learning-driven hybrid attention. \textit{Biochimica et Biophysica Acta (BBA)---Proteins and Proteomics}, 141102. \href{https://doi.org/10.1016/j.bbapap.2025.141102}{doi:10.1016/j.bbapap.2025.141102}
}

\cvitem{2022}{%
  Sarkar, C.; Sarkar, D.; Parsad, R.; Mishra, D. Package \texttt{EGRNi}. \textbf{CRAN}.
...
\cvitem{2025}{%
  \textbf{Google TRC (TPU Research Cloud) Award} --- Granted free access to Google Cloud TPUs (v4, v5e, v6e) for machine learning research. Project: \texttt{dpnproject1}.
}
